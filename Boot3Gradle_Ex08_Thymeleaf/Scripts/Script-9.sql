...
CREATE TABLE poll(
   ...
   item varchar2(1000) NOT NULL, -- 투표 항목
   cnt varchar2(1000) NOT NULL -- 투표 결과
);

INSERT INTO poll VALUES 
(poll_id_seq.nextval,'제일 좋아하는 과목은?','HTML|CSS|JAVA|SPRING|JS','0|0|0|0|0');

INSERT INTO poll VALUES 
(poll_id_seq.nextval,'제일 싫어하는 과목은?','HTML|CSS|JAVA|SPRING|JS','5|12|23|11|7');
INSERT INTO poll VALUES 
