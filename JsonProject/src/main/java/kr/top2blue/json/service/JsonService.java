package kr.top2blue.json.service;
...
import kr.top2blue.json.vo.BoxOffice;
import kr.top2blue.json.vo.BoxOffice2;
import kr.top2blue.json.vo.DataVO;
...
public class JsonService {
	...
	public BoxOffice2 getBoxOffice2(String targetDt) {
		...
		// 연결할 주소를 만들어 주어야 한다.
		String urlAddress="";
		urlAddress +="http://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchWeeklyBoxOfficeList.json";
		urlAddress +="?key=f5eef3421c602c6cb7ea224104795888";
		urlAddress +="&targetDt=" + targetDt;
